...
%
% This script tests that high quality pitch shifting can be performed using
% phase deviation from bin frequencies.
%
% COMMANDS:
% bigfft -  computes a 16k point FFT to get the highest magnitude frequency
%           within 2.93 Hz accuracy.
% +=====+=====+=====+=====+=====+=====+=====+=====+=====+=====+=====+=====+
close all
clear all
clc
...
% set up the plots for board spectrums
